export const baseUrl = 'http://45.55.151.65';
export const loginUrl = 'http://45.55.151.65/login';
export const graphqlUrl = 'http://45.55.151.65/graphql';

export const currencyOptions = [
  // { key: 'n', value: '', text: 'None' },
  { key: 'usd', value: 'usd', icon: 'dollar', text: 'USD' },
  { key: 'eu', value: 'euro', icon: 'euro', text: 'Euro' },
  { key: 'po', value: 'pound', icon: 'pound', text: 'Pound' },
  { key: 'ye', value: 'yen', icon: 'yen', text: 'Yen' },
  { key: 'bi', value: 'bitcoin', icon: 'bitcoin', text: 'Bitcoin' },
];
